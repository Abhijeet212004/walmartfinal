        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="space-y-6 lg:sticky lg:top-6">
              {/* Right Column Header - Match left column height */}
              <div className="text-center lg:text-left py-8">
                <h2 className="text-4xl font-black text-white mb-4">
                  <span className="bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent">Live</span>
                  <span className="text-white"> Intelligence</span>
                </h2>
                <p className="text-gray-300 text-lg">Real-time monitoring and insights dashboard</p>
              </div>
