...
const Dashboard = () => {
  ...
  const StatCard = ({ title, value, icon: IconComponent, change, changeType, color = "blue", gradient = false }) => {
    const colorClasses = {
  ...
  // eslint-disable-next-line no-unused-vars
  const FeatureCard = ({ title, description, icon: IconComponent, color, badge }) => {
    return (
